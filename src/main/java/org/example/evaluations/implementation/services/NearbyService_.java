...
public class NearbyService_ {
    ...
    public Boolean addLocation(Restaurant_ restaurant) {
    ...
    public List<Restaurant_> findNearbyLocations(double userLatitude, double userLongitude, double radius) {
        GeoOperations<String, Object> geoOps = redisTemplate.opsForGeo();
        ...
        return geoResults.stream()
                ...
                .map(id -> (Restaurant_) redisTemplate.opsForHash().get(LOCATION_KEY, id))
