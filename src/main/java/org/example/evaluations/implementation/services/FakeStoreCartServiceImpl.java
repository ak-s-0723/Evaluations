...
import org.example.evaluations.implementation.clients.FakeStoreClientImpl;
import org.example.evaluations.implementation.dtos.FakeStoreCart;
...
@Service
public class FakeStoreCartServiceImpl implements ICartService {

    @Autowired
    private FakeStoreClientImpl fakeStoreClientImpl;
