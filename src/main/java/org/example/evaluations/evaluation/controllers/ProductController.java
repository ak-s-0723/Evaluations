...
public class ProductController {
    ...
    public Slice<Product> findProductsWhichCanBeSkippedInLuggageBecauseOfWeightLimit(@RequestParam Integer pageNumber, @RequestParam Integer pageSize, @PathVariable("actualWeight") Double actualWeight, @PathVariable("weightLimit") Double weightLimit) {
        return productSearchService.findProductsWhichCanBeSkippedInLuggageBecauseOfWeightLimit(weightLimit,actualWeight,pageNumber,pageSize);
    }
    ...
    public Slice<Product> findProductsBelongingToCategoryDisplayedByAge(@RequestParam Integer pageNumber, @RequestParam Integer pageSize, @PathVariable String category) {
        return productSearchService.findProductsBelongingToCategoryDisplayedByAge(category,pageNumber,pageSize);
    }
