SOURCE_BRANCH="changes1"  # The branch you want to check if it has been merged
TARGET_BRANCH="main"            # The branch you want to check if the source branch has been merged into
EXPECTED_EXTRA_COMMITS=2        # Number of extra commits expected in the target branch
